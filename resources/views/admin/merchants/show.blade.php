                ...
                <div class="card-body">
                    ...
                    <div class="row text-center mb-3">
                        ...
                        <div class="col-md-3 border-end">
                            ...
                            <h5 class="fw-bold text-success">{{ $summary['partially_delivered'] ?? 0 }}</h5>
                        </div>
                        <div class="col-md-3">
                        ...
                        <table class="table table-sm table-hover align-middle mb-0">
                            ...
                            <tbody>
                                @forelse($shipments as $s)
                                    <tr
                                        onclick="window.location='{{ route('admin.shipments.show', $s) }}'"
                                        role="button"
                                        class="clickable-row"
                                    >
                                        ...
                                        <td>
                                            ...
                                            @php
                                                ...
                                                $badgeColor = $statusColors[$status] ?? '#adb5bd'; // fallback: gray
                                            @endphp
