                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="card text-center p-3 shadow-sm border-0 h-100">
                                ...
                                <div class="h5 fw-bold text-secondary">
                                    ৳ {{ $earnings[$key]['total_count'] > 0 ? number_format($earnings[$key]['total_earning'] / $earnings[$key]['total_count'], 2) : '5.00' }}
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-striped mb-0 align-middle">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center small">৳ {{ $earnings[$key]['delivered'] > 0 ? number_format($earnings[$key]['delivered_earning'] / $earnings[$key]['delivered'], 2) : '5.00' }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center small">৳ {{ $earnings[$key]['cancelled'] > 0 ? number_format($earnings[$key]['cancelled_earning'] / $earnings[$key]['cancelled'], 2) : '5.00' }}</td>
