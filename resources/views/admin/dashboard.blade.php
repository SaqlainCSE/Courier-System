        ...
        <div class="row g-3 mb-4">
            @php
                $stats = [
                    ...
                    ['label' => 'Today All Marchant COD Collected', 'value' => $TodayAllMarchantCODCollected, 'color' => 'primary'],
                    ['label' => 'Today Marchant Paid Amount', 'value' => $todayMarchantPaidAmount, 'color' => 'success'],
                    ['label' => 'Today Marchant Unpaid Amount', 'value' => $todayMarchantUnpaidAmount, 'color' => 'danger'],
                    ['label' => 'Today Partial Amount', 'value' => $todayPartialAmount, 'color' => 'dark'],
                    ...
                    ['label' => 'Today Pending', 'value' => $pendingShipments, 'color' => 'warning', 'isCurrency' => false],
                    ['label' => 'Today In Transit', 'value' => $inTransitShipments, 'color' => 'primary', 'isCurrency' => false],
                    ['label' => 'Today Delivered', 'value' => $deliveredShipments, 'color' => 'success', 'isCurrency' => false],
                    ['label' => 'Today Partially Delivered', 'value' => $partiallyDeliveredShipments, 'color' => 'dark', 'isCurrency' => false],
                    ['label' => 'Today On Hold', 'value' => $holdShipments, 'color' => 'secondary', 'isCurrency' => false],
                    ['label' => 'Today Cancelled', 'value' => $cancelledShipments, 'color' => 'danger', 'isCurrency' => false],
                    ['label' => 'Active Delivery Man', 'value' => $activeCouriers, 'color' => 'secondary', 'isCurrency' => false,],
                ];
            @endphp
